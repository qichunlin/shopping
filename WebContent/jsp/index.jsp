...
<html>
	...
	<head>
		...
		<title>Legend Of Shopping</title>
			...
			<div class="container-fluid">
				...
				<c:forEach items="${hots }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${p.pid}">  <!-- 访问的是get方法 -->
							<img src="${p.PIMAGE }" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/jsp/product_info.jsp" style='color:#666'>${p.pname }</a></p>
