...
public class SendJMail {
		...
		//发送者邮箱地址   相当于服务器    有个授权码
		String from = "lanqiao_1class@163.com";// 邮件发送人的邮件地址
		//注册的时候填写的邮箱地址
		String to = email; // 邮件接收人的邮件地址
		final String username = "lanqiao_1class@163.com"; //发件人的邮件帐户
		//授权码
		final String password = "a62134787";//发件人的邮件密码
